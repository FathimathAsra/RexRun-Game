...
pygame.display.set_caption("Rex Run")

clock = pygame.time.Clock()

# load audio files
jump_sound = pygame.mixer.Sound("sound/jump.ogg")
score_sound = pygame.mixer.Sound("sounds/harmonicaCoin.mp3")
game_over_sound = pygame.mixer.Sound("sounds/Error or failed.mp3")
...
class AllBackgrounds:
    ...
    def __init__(self, game_speed):
        ...
        self.background_2 = Background("image/background/bg_5.png", game_speed - 13)
...
# class for creating and moving our rex buddy
class Rex:
    ...
    def __init__(self):
        ...
        # these indexes cycle through the images of the sprites, make the rex look moving
        self.idle_index = 0
    ...
    def check_collision(self, all_cactus):
        ...
        if self.running:
            dino_mask = pygame.mask.from_surface(self.running_images[self.running_index])  #creates a mask from the given surface
        elif self.jumping:
...
class GameOver:
    ...
    def draw(self):
        draw_text("GAME OVER", "font/Bungee-Regular.ttf", 80, (255, 0, 0),
...
def start_game():
    ...
    while run:
        ...
        if game_over:
            ...
            if rex.check_collision(cactus.get_cactus()):
                game_over = True
                game_over_screen.draw()
